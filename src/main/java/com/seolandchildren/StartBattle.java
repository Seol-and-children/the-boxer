...
public class StartBattle {
    ...
    public void startBattle() {
        ...
        playerHp = 100;;      //player.getStamina();        임시
        enemyHp = 100;
            ...
            switch (cnt) {
                case 1:         //플레이어가 공격을 했을 경우
                    if (enemyCNT <=2) {           //적이 공격했을 때
                        ...
                        takeHp = evs.evasion(playerHp, enemyAttack, enemyAvoid);
                        if (takeHp == playerHp) System.out.println("==========\n" +
                                playerName + "의 공격! \t"+enemyName+"의 회피!\n"+
                                "적이 공격을 회피했다!!");
                        else { System.out.println("==========\n" +
                                    playerName + "의 공격! \t"+enemyName+"의 회피!\n"+
                                    "적이 공격을 회피하고 카운터를 날렸다!!\n" +
                ...
                case 3:         //플레이어가 회피를 했을 경우
                    if (enemyCNT <=2) {     //적이 공격했을 때
                        takeHp = evs.evasion(enemyHp, playerAttack, playerAvoid);
                        if (takeHp == enemyHp) System.out.println("==========\n" +
